...
export default function (props) {
    ...
    if(props.onOmistaja === false){
      nappi=<button onClick={()=>props.lisaaOstoskoriin(props.RavintolanRuuat.Tuote, props.RavintolanRuuat.Kuvaus, props.RavintolanRuuat.Hinta, props.RavintolanRuuat.idRuoka)}>Lisää ostoskoriin</button>
    }
